...
export class ColorParser {
    ...
    public parseGameTextColor(colorChar: string, lightLevels: number = 0): vscode.Color | undefined {
        const baseColors: { [key: string]: vscode.Color } = {
            'r': new vscode.Color(0.61, 0.09, 0.10, 1),
            'g': new vscode.Color(0.18, 0.35, 0.15, 1),
            'b': new vscode.Color(0.17, 0.20, 0.43, 1),
