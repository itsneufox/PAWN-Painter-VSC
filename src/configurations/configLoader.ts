...
export class ConfigurationLoader {
    ...
    public loadConfiguration(): void {
        ...
        this.currentConfig = {
            ...
            inlineText: {
                codeEnabled: vsConfig.get(
                    'inlineText.codeEnabled',
                    DEFAULT_CONFIG.inlineText.codeEnabled,
                ),
                textEnabled: vsConfig.get(
                    'inlineText.textEnabled',
                    DEFAULT_CONFIG.inlineText.textEnabled,
                ),
                codeStyle: vsConfig.get(
                    'inlineText.codeStyle',
                    DEFAULT_CONFIG.inlineText.codeStyle,
                ),
                textStyle: vsConfig.get(
                    'inlineText.textStyle',
                    DEFAULT_CONFIG.inlineText.textStyle,
                ),
            },
        };
    }
