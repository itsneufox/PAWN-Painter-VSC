...
export const GAME_TEXT_COLORS: { [key: string]: GameTextColor } = {
    r: { baseColor: new vscode.Color(0.61, 0.09, 0.1, 1), symbol: '~r~' },
    g: { baseColor: new vscode.Color(0.18, 0.35, 0.15, 1), symbol: '~g~' },
    b: { baseColor: new vscode.Color(0.17, 0.2, 0.43, 1), symbol: '~b~' },
...
export const LIGHTENED_COLORS: { [key: string]: vscode.Color[] } = {
    ...
    g: [
        ...
        new vscode.Color(0.41, 0.8, 0.34, 1),
        new vscode.Color(0.61, 0.87, 0.5, 1),
    ],
    b: [
    ...
    p: [new vscode.Color(0.85, 0.56, 0.87, 1), new vscode.Color(0.87, 0.84, 0.87, 1)],
    y: [new vscode.Color(0.87, 0.87, 0.5, 1), new vscode.Color(0.87, 0.87, 0.75, 1)],
